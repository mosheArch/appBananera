...
urlpatterns = [
    ...
    path('listaReporte', login_required(views.ListaParaReporte.as_view()), name = 'listaReporte'),
    path('empleadosEliminados', login_required(views.EmpleadosEliminados.as_view()), name = 'eliminados'),
    path('editarEmpleado/<int:pk>', views.ActualizarEmpleado.as_view(), name = 'editarEmpleado'),
    path('editarEmpleadoEliminado/<int:pk>', views.ActualizarEmpleadoEliminado.as_view(), name = 'editarEmpleadoEliminado'),
    #path('EliminarEmpleadoCampos/<int:pk>', views.EliminarEmpleadoCampos.as_view(), name = 'editarEmpleadoCampos'),
